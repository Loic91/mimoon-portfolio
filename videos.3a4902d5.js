...
},{"gsap":"TpQl"}],"aDqt":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"ZwjX":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"QAWR":[function(require,module,exports) {
"use strict";
...
},{}],"mJGq":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_Observer.Observer, _SplitText.SplitText);

var animationObserver = /*#__PURE__*/_createClass(function animationObserver() {
  _classCallCheck(this, animationObserver);

  var sections = document.querySelectorAll(".section"),
      images = document.querySelectorAll(".bg"),
      headings = _gsap.gsap.utils.toArray(".section-heading"),
      outerWrappers = _gsap.gsap.utils.toArray(".outer"),
      innerWrappers = _gsap.gsap.utils.toArray(".inner"),
      splitHeadings = headings.map(function (heading) {
    return new _SplitText.SplitText(heading, {
  ...
  wrap = _gsap.gsap.utils.wrap(0, sections.length - 0),
      animating;

  _gsap.gsap.set(outerWrappers, {
    yPercent: 100
  });

  _gsap.gsap.set(innerWrappers, {
    yPercent: -100
  });
  ...
  function gotoSection(index, direction) {
    ...
    if (currentIndex >= 0) {
      ...
      _gsap.gsap.set(sections[currentIndex], {
        zIndex: 0
      });
    ...
    tl.fromTo([outerWrappers[index], innerWrappers[index]], {
      ...
      yPercent: 0
    }, 0).fromTo(images[index], {
      yPercent: 15 * dFactor
    }, {
      yPercent: 0
    }, 0).fromTo(splitHeadings[index].chars, {
      autoAlpha: 0,
...
exports.default = animationObserver;
},{"gsap":"TpQl","gsap/Observer":"QAWR","gsap/SplitText":"BtuU"}],"JP87":[function(require,module,exports) {
"use strict";
...
var _animationObserver = _interopRequireDefault(require("./animationObserver"));
...
new _animationObserver.default(); // new parallax()
},{"../../utils/transition":"Hu2L","../../utils/navigation":"eJdp","./animation":"ZwjX","./animationObserver":"mJGq"}]},{},["JP87"], null)