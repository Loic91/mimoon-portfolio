...
},{"./utils/strings.js":"aDqt"}],"fyTu":[function(require,module,exports) {
"use strict";
...
var animation = /*#__PURE__*/_createClass(function animation() {
  ...
  var tl = _gsap.gsap.timeline(),
      mySplitText = new _SplitText.SplitText(".item a", {
    type: "words,chars"
  }),
      chars = mySplitText.chars; //an array of all the divs that wrap each character


  _gsap.gsap.set(".item a", {
    perspective: 550
  });
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"eJdp":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"Kpio":[function(require,module,exports) {
"use strict";
...
// Affiches des images au survol de la souris
...
},{}],"y6IC":[function(require,module,exports) {
"use strict";
...
var parallax = /*#__PURE__*/_createClass(function parallax() {
  ...
  $(function () {
    //*** !!!
    // Créer une div qui enveloppe les éléments a recevoir l'effet parallax : id="parallax-container"
    // Chaques éléments doit contenir dans sa div le mot clé ainsi que la densité : class="parallax" data-speed="10"
    // !!! ***/
    ...
    $(document).on("mousemove", function (event) {
      ...
      $parallaxItems.each(function () {
        ...
        _gsap.gsap.to(item, 0.5, {
          x: (item.position().left + pageX * speed) * fixer,
          //calculate the new X based on mouse position * speed 
...
},{"gsap":"TpQl"}],"reuc":[function(require,module,exports) {
"use strict";
...
var _parallax = _interopRequireDefault(require("../../utils/parallax"));
...
},{"../../utils/transition":"Hu2L","./animation":"fyTu","../../utils/navigation":"eJdp","./menu":"Kpio","../../utils/parallax":"y6IC"}]},{},["reuc"], null)