...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"Hu2L":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl"}],"srkp":[function(require,module,exports) {
"use strict";
...
var preloader = /*#__PURE__*/_createClass(function preloader() {
  _classCallCheck(this, preloader);

  _gsap.gsap.to(".first", 2.4, {
    delay: 2.2,
    // top: "-100%",
    x: "-101%",
...
},{"gsap":"TpQl"}],"QAWR":[function(require,module,exports) {
"use strict";
...
},{"./utils/strings.js":"aDqt"}],"tsk4":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger, _ScrollSmoother.ScrollSmoother, _SplitText.SplitText);
...
_ScrollSmoother.ScrollSmoother.create({
  ...
  // smoothTouch: 0.0000001,      // temps de lissage beaucoup plus court sur les appareils tactiles (la valeur par défaut est AUCUN lissage sur les appareils tactiles)
...
var animation = /*#__PURE__*/_createClass(function animation() {
  ...
  installMediaQueryWatcher("(min-width: 1025px)", function (matches) {
    if (matches) {
      var split3 = new _SplitText.SplitText("#quote__2", {
        type: "words,chars"
      });

      var tlInner = _gsap.gsap.timeline({
        scrollTrigger: {
          trigger: ".container__title__2",
          start: 'top center' // toggleActions: "restart reset restart reset"
      ...
      _gsap.gsap.utils.toArray('#quote__2').forEach(function (title) {
        var childSplit = new _SplitText.SplitText(title, {
          type: "lines",
          linesClass: "split-child"
        });
        var parentSplit = new _SplitText.SplitText(title, {
          linesClass: "split-parent"
        });

        _gsap.gsap.from(childSplit.lines, {
          scrollTrigger: title,
          start: 'top center',
          duration: 3.5,
          // delay: 2,
  ...
  installMediaQueryWatcher("(min-width: 1025px)", function (matches) {
    if (matches) {
      var split = new _SplitText.SplitText("#quote__3", {
        type: "words,chars"
      });

      var tlInner2 = _gsap.gsap.timeline({
        scrollTrigger: {
          trigger: ".container__title__3",
          start: 'top center' // toggleActions: "restart reset restart reset"
      ...
      _gsap.gsap.utils.toArray('#quote__3').forEach(function (title) {
        var childSplit = new _SplitText.SplitText(title, {
          type: "lines",
          linesClass: "split-child"
        });
  ...
  installMediaQueryWatcher("(min-width: 1025px)", function (matches) {
    if (matches) {
      var quote = document.getElementById("quote__cursive"),
          myCursiveSplitText = new _SplitText.SplitText(quote, {
        type: "words"
      }),
          // tlcursive = gsap.timeline({
      //   delay:0.5, 
      //   repeat:10, 
      //   repeatDelay:1
      // }),
      tlcursive = _gsap.gsap.timeline({
        scrollTrigger: {
          trigger: ".container",
          start: 'top center',
          delay: 0.5 // repeat:10,
          ...
          numWords = myCursiveSplitText.words.length; //prep the quote div for 3D goodness


      _gsap.gsap.set(quote, {
      ...
      for (var i = 0; i < numWords; i++) {
        tlcursive.from(myCursiveSplitText.words[i], 1.5, {
      ...
      tlcursive.from(quote, tlcursive.duration(), {
        rotationY: 180,
        transformOrigin: "50% 75% 200",
        ease: _gsap.Power2.easeOut
      }, 0); //remettre "quote__cursive" en position normale

      tlcursive.to(myCursiveSplitText.words, 0.5, {
        z: 0,
        opacity: 1
      }, "reset");
      tlcursive.to(quote, 0.5, {
        rotationY: 0,
        rotationX: 0
      }, "reset");
    } else {
      _gsap.gsap.from("#quote__cursive", 1.5, {
        y: "10%",
        opacity: 0,
        ease: "slow",
        delay: 0.1,
  ...
  installMediaQueryWatcher("(min-width: 1025px)", function (matches) {
    if (matches) {
      var quote2 = document.getElementById("quote__cursive2"),
          myCursiveSplitText2 = new _SplitText.SplitText(quote2, {
        type: "words"
      }),
          // tlcursive = gsap.timeline({
      //   delay:0.5, 
      ...
      //   repeatDelay:1
      // }),
      tlcursive2 = _gsap.gsap.timeline({
        scrollTrigger: {
          trigger: ".container2",
          start: 'top center',
          delay: 0.5,
          ...
          numWords2 = myCursiveSplitText2.words.length; //prep the quote div for 3D goodness


      _gsap.gsap.set(quote2, {
        transformPerspective: 600,
        perspective: 300,
        transformStyle: "preserve-3d",
        autoAlpha: 1
      ...
      for (var i = 0; i < numWords2; i++) {
        tlcursive2.from(myCursiveSplitText2.words[i], 1.5, {
          z: randomNumber(-500, 300),
          opacity: 0,
          rotationY: randomNumber(-40, 40)
        }, Math.random() * 1.5);
      ...
      tlcursive2.from(quote2, tlcursive2.duration(), {
        rotationY: 180,
        transformOrigin: "50% 75% 200",
        ease: _gsap.Power2.easeOut
      }, 0); //remettre "quote__cursive" en position normale

      tlcursive2.to(myCursiveSplitText2.words, 0.5, {
        z: 0,
        opacity: 1
      }, "reset");
      tlcursive2.to(quote2, 0.5, {
        rotationY: 0,
        rotationX: 0
      }, "reset");
    } else {
      _gsap.gsap.from("#quote__cursive2", 1.5, {
        y: "10%",
        opacity: 0,
        ease: "slow",
        delay: 0.1,
  ...
  installMediaQueryWatcher("(min-width: 1025px)", function (matches) {
    if (matches) {
      var quote3 = document.getElementById("quote__cursive3"),
          myCursiveSplitText3 = new _SplitText.SplitText(quote3, {
        type: "words"
      }),
          // tlcursive = gsap.timeline({
      //   delay:0.5, 
      ...
      //   repeatDelay:1
      // }),
      tlcursive3 = _gsap.gsap.timeline({
        scrollTrigger: {
          trigger: ".container3",
          start: 'top center',
          delay: 0.5,
          ...
          numWords3 = myCursiveSplitText3.words.length; //prep the quote div for 3D goodness


      _gsap.gsap.set(quote3, {
        transformPerspective: 600,
        perspective: 300,
        transformStyle: "preserve-3d",
        autoAlpha: 1
      ...
      for (var i = 0; i < numWords3; i++) {
        tlcursive3.from(myCursiveSplitText3.words[i], 1.5, {
          z: randomNumber(-500, 300),
          opacity: 0,
          rotationY: randomNumber(-40, 40)
        }, Math.random() * 1.5);
      ...
      tlcursive3.from(quote3, tlcursive3.duration(), {
        rotationY: 180,
        transformOrigin: "50% 75% 200",
        ease: _gsap.Power2.easeOut
      }, 0); //remettre "quote__cursive" en position normale

      tlcursive3.to(myCursiveSplitText3.words, 0.5, {
        z: 0,
        opacity: 1
      }, "reset");
      tlcursive3.to(quote3, 0.5, {
        rotationY: 0,
        rotationX: 0
      }, "reset");
    } else {
      _gsap.gsap.from("#quote__cursive3", 1.5, {
        y: "10%",
        opacity: 0,
        ease: "slow",
        delay: 0.1,
  ...
  }); // !!!! "helper functions" concernant les animations "quote__cursive"
  ...
  _gsap.gsap.utils.toArray('.h3, .h4').forEach(function (title) {
    var childSplit = new _SplitText.SplitText(title, {
      type: "lines",
      linesClass: "split-child"
    });
  ...
  _gsap.gsap.utils.toArray('.p1').forEach(function (title) {
    var childSplit = new _SplitText.SplitText(title, {
      type: "lines",
      linesClass: "split-child"
    });
  ...
  _gsap.gsap.utils.toArray('#etape').forEach(function (title) {
    var childSplit = new _SplitText.SplitText(title, {
      type: "lines",
      linesClass: "split-child"
    });
  ...
  // ***************************
  // ***************************
  // gsap.to(".wrapper-img", 2.8, {
  //     width: "400",
  //     height: "500",
  //     ease: Expo.easeInOut,
  //     delay: 3.6,
  // });
  // gsap.from(".img__header", 0.8, {
  //     opacity: 0,
  //     ease: Expo.easeInOut,
  //     delay: 3.4,
  // });
  ...
  // =======================================================================
  // =======================================================================
  // Image parallax (grossie au scroll) 
  ...
  var revealContainers = document.querySelectorAll(".reveal__1");
  revealContainers.forEach(function (container) {
    var image = container.querySelector(".img__reveal");

    var tl = _gsap.gsap.timeline({
      scrollTrigger: {
        trigger: container // toggleActions: "restart reset restart reset"
    ...
    tl.from(container, 1.5, {
      xPercent: -100,
      ease: _gsap.Power2.out // ease: Expo.easeInOut
  ...
  var revealContainers_2 = document.querySelectorAll(".reveal__2");
  revealContainers_2.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_3 = document.querySelectorAll(".reveal__3");
  revealContainers_3.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  gridTl.add("start").from(".grid-layout", {
    // ease: "power1",
    ease: "slow(0.01, 0.01)",
    scale: 3
  }, "start").from(".column-1 .grid-image", {
    duration: 0.6,
  ...
  }, "start").from(".column-3 .grid-image", {
    duration: 0.6,
    xPercent: function xPercent(i) {
      return (i + 1) * 40 + i * 100;
    },
  ...
  var revealContainers_5 = document.querySelectorAll(".reveal__4");
  revealContainers_5.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_6 = document.querySelectorAll(".reveal__5");
  revealContainers_6.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_7 = document.querySelectorAll(".reveal__6");
  revealContainers_7.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_8 = document.querySelectorAll(".reveal__7");
  revealContainers_8.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_9 = document.querySelectorAll(".reveal__8");
  revealContainers_9.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
  ...
  var revealContainers_10 = document.querySelectorAll(".reveal__9");
  revealContainers_10.forEach(function (container) {
    var image = container.querySelector(".img__reveal");
...
},{"gsap":"TpQl","gsap/ScrollTrigger":"TgBN","gsap/ScrollSmoother":"x9Pq","gsap/SplitText":"BtuU"}],"eJdp":[function(require,module,exports) {
"use strict";
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"tO6K":[function(require,module,exports) {
"use strict";
...
},{"../../utils/transition":"Hu2L","../../preloader/preloader":"srkp","./animation":"tsk4","../../utils/navigation":"eJdp"}]},{},["tO6K"], null)