...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
  ...
  var _vars2 = vars,
    ...
    normalizeScrollX && (scrollClampX = _clamp(0, _maxScroll(_docEl, _Observer._horizontal)));
    ...
    updateClamps();
    tween.isActive() && tween.vars.scrollY > maxY && tween.resetTo("scrollY", _maxScroll(_docEl, _Observer._vertical));
  };
  ...
  vars.onRelease = vars.onGestureStart = function (self, wasDragging) {
    ...
    if (!wasDragging || Math.abs(self.x - self.startX) <= 3 && Math.abs(self.y - self.startY) <= 3) {
      ...
      if (normalizeScrollX) {
        ...
        dur *= _clampScrollAndGetDurationMultiplier(scrollFuncX, currentScroll, endScroll, _maxScroll(_docEl, _Observer._horizontal));
      ...
      dur *= _clampScrollAndGetDurationMultiplier(scrollFuncY, currentScroll, endScroll, _maxScroll(_docEl, _Observer._vertical));
...
},{"./Observer.js":"QAWR"}],"x9Pq":[function(require,module,exports) {
"use strict";
...
},{"./utils/strings.js":"aDqt"}],"eJdp":[function(require,module,exports) {
"use strict";
...
var navigation = /*#__PURE__*/_createClass(function navigation() {
  ...
  $('a').hover(function () {
    var $text1 = new _SplitText.SplitText($(this).find('.inital'), {
      type: "words,chars"
    }),
        chars1 = $text1.chars;
    var $text2 = new _SplitText.SplitText($(this).find('.hover'), {
      type: "words,chars"
    }),
        chars2 = $text2.chars;

    var tlHover = _gsap.gsap.timeline({}).to(chars1, 0.5, {
      yPercent: -100,
...
},{"gsap":"TpQl","gsap/SplitText":"BtuU"}],"Hu2L":[function(require,module,exports) {
"use strict";
...
var transition = /*#__PURE__*/_createClass(function transition() {
  ...
  function revealLoad() {
    var tl_transitIn = _gsap.gsap.timeline({
      defaults: {
        duration: 1,
        ease: _gsap.Expo.easeInOut // ease: "Slow",
    ...
    tl_transitIn.to(".overlay", {
      scaleY: 1,
      // opacity: 1,
      transformOrigin: "center bottom"
    }, 0);
    tl_transitIn.to(".preloader__transition", {
      autoAlpha: 1
    }, 0.4);
  } // Transitions Out
  // ================
  ...
  function hideLoad() {
    var tl_transitOut = _gsap.gsap.timeline({
      defaults: {
        duration: 1,
        ease: _gsap.Expo.easeInOut // ease: "Slow",
    ...
    tl_transitOut.to(".preloader__transition", {
      autoAlpha: 0
    });
    tl_transitOut.to(".overlay", {
      scaleY: 0,
      // opacity: 0,
  ...
  $("a").not('[target="_blank"]') // omit from selection
...
},{"gsap":"TpQl"}],"qdkx":[function(require,module,exports) {
"use strict";
...
var Material = /*#__PURE__*/function () {
  ...
  _createClass(Material, [{
    ...
    value: function parse() {
      ...
      for (var i = 0; i < gl.getProgramParameter(this.program, gl.ACTIVE_UNIFORMS); i++) {
      ...
      for (var _i = 0; _i < gl.getProgramParameter(this.program, gl.ACTIVE_ATTRIBUTES); _i++) {
        var attrib = gl.getActiveAttrib(this.program, _i);
    ...
    value: function setUniform(name, value) {
      var uniform = this.uniformsList.get(name);
      ...
      var location = this.uniformsLoc.get(name);
    ...
    key: "createProgram",
    value: function createProgram(gl, vertex, fragment) {
      var v = this.createShader(gl, gl.VERTEX_SHADER, vertex);
      var f = this.createShader(gl, gl.FRAGMENT_SHADER, fragment);
...
},{}],"wA7C":[function(require,module,exports) {
"use strict";
...
var Mat4 = /*#__PURE__*/function (_Array) {
  ...
  _createClass(Mat4, [{
    ...
    value: function scale(v) {
      ...
      _scale(this, m, typeof v === "number" ? [v, v, v] : v);
    ...
    value: function multiply(ma, mb) {
      if (mb) {
        _multiply(this, ma, mb);
      } else {
        _multiply(this, this, ma);
      }
...
exports.Mat4 = Mat4;
},{}],"nSok":[function(require,module,exports) {
"use strict";
...
var Carpet = /*#__PURE__*/function () {
  function Carpet(instance, dom) {
    var _this = this;

    var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        material = _ref.material,
        _ref$wireframe = _ref.wireframe,
        wireframe = _ref$wireframe === void 0 ? false : _ref$wireframe,
        _ref$uniforms = _ref.uniforms,
        uniforms = _ref$uniforms === void 0 ? {} : _ref$uniforms,
        _ref$position = _ref.position,
        position = _ref$position === void 0 ? [0, 0] : _ref$position,
        _ref$scale = _ref.scale,
        scale = _ref$scale === void 0 ? [1, 1] : _ref$scale,
        _ref$order = _ref.order,
        order = _ref$order === void 0 ? 10 : _ref$order;

    _classCallCheck(this, Carpet);
  ...
  _createClass(Carpet, [{
    ...
    value: function resize() {
      ...
      var bounding = this.dom.getBoundingClientRect();
      this.bounds = {
    ...
    value: function updateProjection() {
      this.projection = new _mat.Mat4();
      var aspect = this.instance.aspect;
      var fov = 45 * (Math.PI / 180);
      var distance = this.order;
      var camHeight = 2 * Math.tan(fov / 2) * distance;
      var camWidth = camHeight * aspect;
      var scaleX = this.bounds.width / this.instance.width * camWidth;
      var scaleY = this.bounds.height / this.instance.height * camHeight;
      ...
      this.projection.translate([-(camWidth / 2) + scaleX / 2, camHeight / 2 - scaleY / 2, 0, 0]); // TODO: Cache part of the projection and update only at resize

      var offsetX = this.instance.x - this.position[0];
      var offsetY = this.instance.y - this.position[1];
    ...
    value: function setupVao() {
      ...
      var uvLoc = this.material.attributeLoc.get("uv");
...
},{"./mat4.js":"wA7C"}],"ElAl":[function(require,module,exports) {
"use strict";
...
var Plane = /*#__PURE__*/function () {
  function Plane(instance) {
    _classCallCheck(this, Plane);

    var gl = instance.gl;

    var _this$build = this.build(instance.density),
        position = _this$build.position,
        index = _this$build.index,
        uv = _this$build.uv;
  ...
  _createClass(Plane, [{
    ...
    value: function build(density) {
      ...
      var height = 1;
      var depth = 0;
      var widthSegments = density;
      var heightSegments = density;
      var wSegs = widthSegments;
      var hSegs = heightSegments;
      var num = (wSegs + 1) * (hSegs + 1);
      var numIndices = wSegs * hSegs * 6;
      var position = new Float32Array(num * 2); // const normal = new Float32Array(num * 3);
      ...
      for (var iy = 0; iy <= hSegs; iy++) {
        ...
        for (var ix = 0; ix <= wSegs; ix++, i++) {
          ...
          position[i * 2 + v] = y * vDir; // position[i * 3 + w] = depth / 2;
          // normal[i * 3 + u] = 0;
          // normal[i * 3 + v] = 0;
...
},{}],"aC2R":[function(require,module,exports) {
"use strict";
...
var Texture = /*#__PURE__*/function () {
  function Texture(instance, url) {
    var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        _ref$anisotropy = _ref.anisotropy,
        anisotropy = _ref$anisotropy === void 0 ? false : _ref$anisotropy;
  ...
  _createClass(Texture, [{
    ...
    value: function onLoad() {
      var gl = this.gl; //TODO: make it power of two?
      ...
      if (this.anisotropy && this.instance.anisotropy) {
        var ext = this.instance.anisotropy;
...
},{}],"VkaU":[function(require,module,exports) {
"use strict";
...
var _material = _interopRequireDefault(require("./material.js"));

var _carpet = _interopRequireDefault(require("./carpet.js"));
...
var Aladino = /*#__PURE__*/function () {
  function Aladino() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$canvas = _ref.canvas,
        canvas = _ref$canvas === void 0 ? document.createElement("canvas") : _ref$canvas,
        _ref$dpr = _ref.dpr,
        dpr = _ref$dpr === void 0 ? Math.min(devicePixelRatio, 2) : _ref$dpr,
        _ref$density = _ref.density,
        density = _ref$density === void 0 ? 1 : _ref$density,
        ...
        attribs = _ref$attribs === void 0 ? {
      antialias: true
    } : _ref$attribs,
        _ref$autoTick = _ref.autoTick,
        autoTick = _ref$autoTick === void 0 ? true : _ref$autoTick;

    _classCallCheck(this, Aladino);
    ...
    this.plane = new _plane.default(this);
    this.init();
  }

  _createClass(Aladino, [{
    key: "init",
    value: function init() {
    ...
    value: function resize() {
      ...
      this.carpets.forEach(function (carpet) {
        return carpet.resize();
      });
    ...
    key: "material",
    value: function material(args) {
      return new _material.default(this, args);
    }
  }, {
    key: "carpet",
    value: function carpet(dom, args) {
      var el = new _carpet.default(this, dom, args);
    ...
    key: "texture",
    value: function texture(url, args) {
      return new _texture.default(this, url, args);
    }
  }, {
    key: "setupPost",
    value: function setupPost() {
      ...
      var positionLoc = this.postMaterial.attributeLoc.get("position");
      gl.enableVertexAttribArray(positionLoc);
      gl.bindBuffer(gl.ARRAY_BUFFER, this.postTriangle);
      gl.vertexAttribPointer(positionLoc, 2, gl.FLOAT, false, 0, 0);
    ...
    key: "setTextures",
    value: function setTextures(material, list) {
      var gl = this.gl;
      var current = 0;
      material.uniformsList.forEach(function (uniform) {
        if (uniform.type === 35678) {
          var tex = list[uniform.name];
          ...
          var imageName = uniform.name;
          var sizeName = "size" + imageName.charAt(0).toUpperCase() + imageName.substring(1);
    ...
    value: function draw() {
      ...
      gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT); // TODO sort drawing by material?
      ...
      this.carpets.forEach(function (carpet) {
        ...
        if (carpet.material.program !== _this.lastProgramUsed || _this.reset) {
          gl.useProgram(carpet.material.program);

          _this.vao.bindVertexArrayOES(carpet.vao);

          _this.setTextures(carpet.material, carpet.material.uniforms);
        ...
        _this.setTextures(carpet.material, carpet.uniforms);

        carpet.material.setUniforms(carpet.uniforms);
        carpet.draw();
        currentProgram = carpet.material.program;
        _this.lastProgramUsed = carpet.material.program;
      });

      if (this.post) {
        var material = this.postMaterial;
        gl.bindFramebuffer(gl.FRAMEBUFFER, null);
...
exports.default = Aladino;
},{"./material.js":"qdkx","./carpet.js":"nSok","./plane.js":"ElAl","./texture.js":"aC2R"}],"RDX9":[function(require,module,exports) {
"use strict";
...
var Pointer = /*#__PURE__*/function () {
  function Pointer() {
    ...
    this.viewport = [0, 0];
    this.coords = [0, 0]; // this.normalized = [0, 0];
...
},{}],"bBU5":[function(require,module,exports) {
"use strict";
...
var _default = function _default(x, y, r) {
  return x + (y - x) * r;
};
...
var _index = _interopRequireDefault(require("../../utils/aladino/index"));

var _pointer = _interopRequireDefault(require("../../utils/aladino/assets/pointer"));

var _lerp = _interopRequireDefault(require("../../utils/aladino/assets/lerp"));
...
var webgl = /*#__PURE__*/_createClass(function webgl() {
  ...
  var pointer = new _pointer.default();
  var aladino = new _index.default({
    density: 20
  });
  document.body.appendChild(aladino.canvas);
  var material = aladino.material({
    vertex:
    /* glsl */
  ...
  var update = function update() {
    ...
    carpet.position[0] = (0, _lerp.default)(carpet.position[0], pointer.coords[0] - carpet.bounds.width / 2, 0.2);
    carpet.position[1] = (0, _lerp.default)(carpet.position[1], pointer.coords[1] - carpet.bounds.height / 2, 0.2);
    carpet.uniforms.speed[0] = (0, _lerp.default)(carpet.uniforms.speed[0], (carpet.position[0] - oldSpeed[0]) * 0.1, 0.7);
    carpet.uniforms.speed[1] = (0, _lerp.default)(carpet.uniforms.speed[1], (carpet.position[1] - oldSpeed[1]) * 0.1, 0.7);
...
},{"../../utils/aladino/index":"VkaU","../../utils/aladino/assets/pointer":"RDX9","../../utils/aladino/assets/lerp":"bBU5"}],"QUR1":[function(require,module,exports) {
"use strict";
...
_gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger, _SplitText.SplitText);

var animation = /*#__PURE__*/_createClass(function animation() {
  _classCallCheck(this, animation);

  var splitLines = new _SplitText.SplitText('#split-me', {
    type: "lines",
...
},{"gsap":"TpQl","gsap/ScrollTrigger":"TgBN","gsap/SplitText":"BtuU"}],"UIMA":[function(require,module,exports) {
"use strict";
...
_ScrollSmoother.ScrollSmoother.create({
  smooth: 1,
  // combien de temps (en secondes) il faut pour "rattraper" la position de défilement native
  effects: true,
  // recherche les attributs data-speed et data-lag sur les éléments
  ignoreMobileResize: true
});

_gsap.gsap.from(".network", 4.5, {
  opacity: 0,
  ease: _gsap.Expo.easeInOut
});
},{"gsap":"TpQl","gsap/ScrollTrigger":"TgBN","gsap/ScrollSmoother":"x9Pq","../../utils/navigation":"eJdp","../../utils/transition":"Hu2L","./webgl":"BFbI","./animation":"QUR1"}]},{},["UIMA"], null)